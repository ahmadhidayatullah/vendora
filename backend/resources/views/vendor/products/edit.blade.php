...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mt-2">Edit Product</h1>
</div>
    ...
    <form method="POST" action="{{ route('vendor.products.update', $product->id) }}">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" rows="3"
                      class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('description', $product->description) }}</textarea>
